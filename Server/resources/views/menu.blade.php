<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Naive Beverage</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-header">Product Sub Category</li>
                        <li><a href="/productsubcategory">Sub category list</a></li>
                        <li><a href="/productsubcategory/add">Add sub category</a></li>
                        <li role="separator" class="divider"></li>
                        <li class="dropdown-header">Product Category</li>
                        <li><a href="/productcategory">Category list</a></li>
